...
namespace EricGames.Core.Triangulations
{
    public class Delaunay
    {
        ...
        {
            var result = new Delaunay(positions);
            return result.Algorithm();
        }

        public Delaunay(Vector2[] positions)
        {
        ...
        private Mesh Algorithm()
        {
            ...
            var vertices = points
                .Select((point) => new Vector3(point.Position.x, point.Position.y, 0))
                .ToArray();
        ...
        static internal bool IsPInCircle(Point c1p, Point c2p, Point c3p, Point pp)
        {
